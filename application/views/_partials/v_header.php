    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            <div class="page-brand">
                <a class="link" href="./">
                    <span class="brand text-center">Management Kost
                        <span class="brand-tip"></span>
                    </span>
                    <span class="brand-mini">MK</span>
                </a>
            </div>
                ...
                <ul class="nav navbar-toolbar">
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <span><?= $this->session->userdata('nama') ?></span><i class="fa fa-angle-down m-l-5"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-right" style="min-width: 150px">
                            ...
                            <a class="dropdown-item" href="<?= base_url('tambah-user') ?>" <?php if ($username != 'admin') echo 'style="display: none"' ?>><i class="fa fa-user"></i>Tambah User</a>
