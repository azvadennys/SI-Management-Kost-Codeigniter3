        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a <?php if ($judul_halaman == 'Daftar User') echo 'class="active"' ?> <?php if ($username != 'admin') echo 'style="display: none"' ?> href="<?= base_url('daftar-user') ?>"><i class="sidebar-item-icon fa fa-user"></i>
